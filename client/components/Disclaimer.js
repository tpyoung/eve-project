  ...
  render(){
    ...
    return (
      <div className="disclaimers">
        ...
        <p>Disclaimer</p>
        <p>Actual results will vary for many reason, including driving conditions and how you drive and maintain your vehicle. The average new vehicle gets 22 MPG and costs $12,600 to fuel over 5 years. Cost estimates are based on 15,000 miles per year at $3.70 per gallon. MPGe is miles per gasoline gallon equivalent. Vehicle emissions are a significant cause of climate change and smog. Electricity and gasoline costs vary and may differ from the values shows above.</p>
      </div>
    )
  }
});
