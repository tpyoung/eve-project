      ...
      <div className='ResultPage'>
        {(this.getGasCars()[0] || this.getHybridCars()[0] || this.getElectricCars()[0]) &&
          <div className="carContainer">
            <Car vehicleInfo={this.getGasCars()[this.state.gasIndex]} getCurrCar={this.getCurrCar} stateInfo={this.props.stateInfo} currIndex={this.state.gasIndex} vehicleLength={this.getGasCars().length} />
            <Car vehicleInfo={this.getHybridCars()[this.state.hybridIndex]} getCurrCar={this.getCurrCar} stateInfo={this.props.stateInfo} currIndex={this.state.hybridIndex} vehicleLength={this.getHybridCars().length} />
            <Car vehicleInfo={this.getElectricCars()[this.state.electricIndex]} getCurrCar={this.getCurrCar} stateInfo={this.props.stateInfo} currIndex={this.state.electricIndex} vehicleLength={this.getElectricCars().length} />
          </div>
        }
